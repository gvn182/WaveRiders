...
public class BinderDataCoin extends BaseAdapter {
	...
	ViewHolder holder;
	public BinderDataCoin() {
		// TODO Auto-generated constructor stub
	}
	
	public BinderDataCoin(Activity act, List<HashMap<String,String>> map) {
...
//		return idlist.size();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    if(convertView==null){
	      ...
	      vi = inflater.inflate(R.layout.list_row_coins, null);
	      ...
	      holder.buyEquipButton = (ImageView)vi.findViewById(R.id.buyImage); // thumb image
	      vi.setTag(holder);
	    }
	    else{
